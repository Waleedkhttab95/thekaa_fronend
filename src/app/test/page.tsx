      ...
      <div className="container mx-auto flex justify-center items-center min-h-screen">
            <Card variant="default" className="w-full max-w-2xl pt-4">
                ...
                <CardContent>
                    <div className="space-y-6">
                        ...
                        <h2 className="text-lg font-tajawal font-medium mb-4">ما هي المادة التي لا تختلط مع المياه؟</h2>
                            ...
                            <div className="space-y-3 p-2">
                                <div className="flex items-center justify-end gap-2 p-3 rounded-lg border hover:bg-gray-50 cursor-pointer">
                                    <label className="w-full text-right cursor-pointer font-ibm font-regular">السكر</label>
                                    <input type="radio" name="answer" className="w-4 h-4" />
                                </div>
                            </div> 
                            <div className="space-y-3 p-2">
                                <div className="flex items-center justify-end gap-2 p-3 rounded-lg border hover:bg-gray-50 cursor-pointer">
                                    <label className="w-full text-right cursor-pointer font-ibm font-regular">الملح</label>
                                    <input type="radio" name="answer" className="w-4 h-4" />
                                </div>
                            </div> 
                            <div className="space-y-3 p-2">
                ...
                <CardFooter>
                        <Button 
                            variant="default"
                            className="w-full max-w-full sm:w-auto bg-gray-900 hover:bg-gray-800 text-white px-4 sm:px-8 py-2 font-pingar font-medium text-sm sm:text-base"
                        >
                            التالي ← 
                        </Button>
                </CardFooter>
