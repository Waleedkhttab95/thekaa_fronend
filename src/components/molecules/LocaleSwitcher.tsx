...
export default function LocaleSwitcher() {
  ...
  return (
    ...
    <button className={ButtonClasses}
      ...
      disabled={isPending}>
      <span className={cn(textClasses, 'hidden md:inline', textmb)}>{t('switchLocale')}</span>
      <span className={cn(textClasses, 'md:hidden', textmb)}>{t('switchLocale-sm')}</span>
      <LanguageICon />
    </button>
