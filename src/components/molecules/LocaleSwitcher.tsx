...
export default function LocaleSwitcher({ onlySmall }: { onlySmall?: boolean }) {
  ...
  if (onlySmall) {
    return (
      <button
        className="flex w-[70px] h-14 justify-center items-center  py-1 bg-white bg-opacity-50 rounded-full gap-2 text-black-500 border-white border-[1px] shadow-inner hover:bg-opacity-70 transition"
