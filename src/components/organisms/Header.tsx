...
const Header = () => {
  ...
  const containerClasses =
    "mx-auto  sm:w-[93%] w-[96%] py-9 flex justify-between items-center";
  ...
  return (
    <div className={containerClasses + " relative z-[1]"}>
      <div className={hiddenDivClasses}></div>
      <Link href="/">
        <Image
          className={logoClasses}
          src={`/assets/images/${locale}-logo.svg`}
          width={150}
          height={50}
          alt={t("Thekaa")}
        />
        <Image
          className={mLogoClasses}
